Rails.application.configure do
  ...
  TkmlAuth.configure do |config|
    config.base_url = "https://auth.tkmldevelopment.com/"
    ...
    config.password_reset_destination = "https://mcsourceonline.com/auth/password/reset"
    config.redeem_invite_path = "https://mcsourceonline.com/auth/invitation/accept"
